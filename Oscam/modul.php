...
class Oscam extends IPSModule {
    ...
    // Der Konstruktor des Moduls
		...
		//$this->RegisterTimer("ReadOscam", 300, 'OSCAM_getData($_IPS[\'TARGET\']);');
        }
	...
	public function getData()
	{
		...
		$url = "$url:$port/oscamapi.html?part=userstats";
		$ch = curl_init();
		...
		foreach( $xml->xpath('/oscam/users/user') as $child)
		{
			...
			vars("$name",$this->InstanceID,'Response',$cwlastresptime,1,"", true, $position);
